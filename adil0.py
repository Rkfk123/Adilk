...
print('\n\033[1;31m ⚡𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ADIL KHAN 𝙵𝙱 𝙲𝙻𝙾𝙽𝙴𝙸𝙽𝙶 𝚃𝙾𝙾𝙻𝚂 ⚡');time.sleep(3)
...
\033[1;31m------------------------------------------------
\033[1;32m》AUTHOR    : ADIL
》FACEBOOK  : MOHD ADIL
》GITHUB    : MOHD ADIL
》TAEM      : SAHIL AMIL ADIL
\033[1;31m------------------------------------------------
"""
def linex():
	print('\033[1;37m----------------------------------------------')
...
def menu():
			...
			if xd in ['02','2']:
				awmafghan1()
			if xd in ['03','3']:
				os.system('https://www.facebook.com/durga.vijay.96343')
				print('\033[1;37m')
				print('\033[1;33m------------------------------------------------')
